    ...
    >
        <v-row class="blue-b" justify="start">
            ...
            <v-col class="green-b" cols="7">
                ...
                <v-card-text>
                    <div> 
                        <p>小学生の頃にゲームが作りたくて工業高校情報科に進学。進学後プログラミングの面白さはゲーム作りだけではないと気づき、エンジニアになるため情報科の大学へ進学を決意。</p>
                        <p>大学で勉強をしていく中でソフトウェアの作り方について知識をつけたいと考えソフトウェア工学を大学院まで研究していました。</p>
                        <p>研究の影響もあり、将来はアーキテクトに強いエンジニアになります。</p>
                        <p>とは言いながらも趣味を捨てきることができない人間で、ゲームやアニメ、ライトノベル、漫画など自分を形成してきた文化を大切にしていきながら仕事をしていきたいです。</p>
                    </div>
                </v-card-text>
            </v-col>
        </v-row>
